<template>
    <section class="bg-topbar-gradient dark:bg-topbar-gradient-dark min-h-screen flex items-center justify-center w-full">
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto w-full">
        <div class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-56 h-56" src="@/images/topbar_icons/logo.svg" alt="logo">
        </div>
